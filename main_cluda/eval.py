...
def main(args):
    ...
    experiment_folder_path = os.path.join(saved_args.experiments_main_folder, saved_args.experiment_folder,
    ...
    df_save_path_trg = os.path.join(saved_args.experiments_main_folder, args.experiment_folder,
                                    str(args.id_src) + "-" + str(saved_args.id_trg), "predictions_test_target.csv")
    ...
    df_save_path_src = os.path.join(saved_args.experiments_main_folder, args.experiment_folder,
                                    str(args.id_src) + "-" + str(saved_args.id_trg), "predictions_test_source.csv")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--id_src', type=str, default='1')
    parser.add_argument('--id_trg', type=str, default='2')
